...
def get_args(rest_args):
    ...
    parser.add_argument('--mixture_number', type=int, default=4, help='how many workers to train with mixture task')
    ...
    # env
    parser.add_argument('--env_name', default='cheetah-vel-inter-v0', help='environment to train on')
    ...
    parser.add_argument('--eval_task_num', type=int, default=9, help='how many environments to evaluate on')
    ...
    parser.add_argument('--auto_multi_head_num', type=int, default=0,
                        help='automatic multi head number, if 0 and multihead for reward true, manual multihead is used')
    parser.add_argument('--multiplicative_context', type=boolean_argument, default=False,
                        help='When multihead is false and multiply context to the reward decoder instead of input')
    ...
    parser.add_argument('--dropout_rate', type=float, default=0.5, help='dropout rate for input s,a,s of decoder')
    ...
    print('args_mujoco_cheetah_vel_ldm', args)
    return args
