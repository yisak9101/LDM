...
def get_args(rest_args):
    ...
    # training parameters
    parser.add_argument('--num_frames', type=int, default=5e8, help='number of frames to train')
    ...
    # env
    parser.add_argument('--env_name', default='cheetah-mass-inter-v0', help='environment to train on')
