...
def get_args(rest_args):
    ...
    # training parameters
    parser.add_argument('--num_frames', type=int, default=1e10, help='number of frames to train')
    ...
    # env
    parser.add_argument('--env_name', default='ant-goal-inter-v0', help='environment to train on')
    ...
    parser.add_argument('--eval_task_num', type=int, default=48, help='how many environments to evaluate on')
