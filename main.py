...
# VariBAD Expert :
from config.mujoco import args_mujoco_ant_goal_inter_expert_varibad
from config.mujoco import args_mujoco_ant_dir_2_expert_varibad
from config.mujoco import args_mujoco_ant_dir_4_expert_varibad
from config.mujoco import args_mujoco_cheetah_vel_inter_expert_varibad
from config.mujoco import args_mujoco_walker_mass_inter_expert_varibad
from config.mujoco import args_mujoco_hopper_mass_inter_expert_varibad
...
def main():
    ...
    # VariBAD Expert
    ##############################################
    if env == 'mujoco_cheetah_vel_inter_expert_varibad':
        args = args_mujoco_cheetah_vel_inter_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner

    elif env == 'mujoco_ant_goal_inter_expert_varibad':
        args = args_mujoco_ant_goal_inter_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner

    elif env == 'mujoco_ant_dir_2_expert_varibad':
        args = args_mujoco_ant_dir_2_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner

    elif env == 'mujoco_ant_dir_4_expert_varibad':
        args = args_mujoco_ant_dir_4_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner

    elif env == 'mujoco_walker_mass_inter_expert_varibad':
        args = args_mujoco_walker_mass_inter_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner

    elif env == 'mujoco_hopper_mass_inter_expert_varibad':
        args = args_mujoco_hopper_mass_inter_expert_varibad.get_args(rest_args)
        args.seed = seed
        from metalearner import MetaLearner
